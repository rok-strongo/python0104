...
while games_count != 0:
    ...
    if rock_count == 0 and paper_count == 0 and scissors_count == 0:
        ...
        if games_count>=3 and rock_count>paper_count and rock_count>scissors_count:
            comp_choice=1
        elif games_count>=3 and paper_count>rock_count and paper_count>scissors_count:
            comp_choice=2
        else:
            if games_count>=3 and scissors_count>rock_count and scissors_count>paper_count:
                comp_choice=0
